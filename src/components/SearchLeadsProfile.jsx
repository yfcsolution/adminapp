...
const SearchLeadProfile = ({ leadId }) => {
  ...
  useEffect(() => {
    const fetchLead = async () => {
      ...
      try {
        const response = await fetch("/api/leads/search-lead-profile", {
          method: "POST",
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="space-y-4">
                ...
                <ProfileField label="Phone" value={data.PHONE_NO} />
...
export default SearchLeadProfile;

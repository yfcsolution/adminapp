...
export default function WhatsAppDashboard() {
  ...
  const fetchAccounts = async () => {
    try {
      const response = await axios.get('https://wa.yourfuturecampus.com/accounts');
  ...
  useEffect(() => {
    const setupEventSource = () => {
      const es = new EventSource('https://wa.yourfuturecampus.com/events');
  ...
  const connectAccount = async (appKey) => {
    try {
      ...
      await axios.post(`https://wa.yourfuturecampus.com/connect/${appKey}`);
    } catch (error) {
  ...
  const deleteAuthData = async (appKey) => {
    ...
    try {
      ...
      await axios.post(`https://wa.yourfuturecampus.com/disconnect/${appKey}`);
      ...
      if (mediaFile) {
        ...
        await new Promise((resolve) => {
          reader.onload = async () => {
            ...
            response = await axios.post('https://wa.yourfuturecampus.com/send-message', {
  ...
  const addAccount = async () => {
    ...
    try {
      const response = await axios.post('https://wa.yourfuturecampus.com/accounts', {

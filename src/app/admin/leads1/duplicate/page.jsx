...
const DuplicateLeadsList = () => {
  ...
  const fetchLeadsData = async () => {
    try {
      const response = await axios.post(`/api/leads/duplicate-list`, {
        page,
        pageSize,
        sortField,
      });
      ...
      toast.error("Failed to fetch duplicate leads data.");
    }
  };
        ...
        <div className="p-6 bg-white rounded-lg max-w-6xl mx-auto">
          ...
          <div className="grid gap-4 md:hidden">
            {Array.isArray(leadsData) && leadsData.length > 0 ? (
              ...
              <p className="text-center text-gray-500">No duplicate leads available.</p>
            )}
          </div>
...
export default DuplicateLeadsList;

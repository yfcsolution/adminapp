        ...
        <nav className="mt-6 px-4 flex-1 overflow-y-auto custom-scrollbar">
          <ul>
            ...
            <SidebarLink
              ...
              label="Payments"
            />
            {/* Updated Whatsapp Link with Dropdown */}
            <li className="mb-3 relative group">
              <Link
                href="/admin/conversations/whatsapp/chat"
                className="flex items-center p-2 space-x-2 rounded-md transition-colors duration-200 text-teal-800 hover:bg-teal-100 hover:text-teal-900"
              >

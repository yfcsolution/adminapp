...
#### Test Direct ERP API:
```bash
curl -X POST https://sss.yourfuturecampus.com:8090/apeks/apps/erp/YfcLeads/insertleads \
  -H "Content-Type: application/json" \
  -d '{
    "LEAD_ID": "TEST_123",
    "FULL_NAME": "Test User",
...
4. **Network Errors**
   - Verify ERP URL is accessible: `https://sss.yourfuturecampus.com:8090/apeks/apps`
...
3. **ERP URL**: Verify `https://sss.yourfuturecampus.com:8090/apeks/apps` is accessible
